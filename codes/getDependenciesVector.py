...
def getDependenciesVector(sentence):
...
vector = getDependenciesVector('1.5 million jobs created during the worst economic time this country has had since the Great Depression while the rest of the country lost 400,000 jobs.')
print(vector)
